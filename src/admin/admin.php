    ...
    <main class="flex flex-col items-center w-full px-4 py-10 space-y-10">
        ...
        <section class="w-full max-w-4xl bg-white p-6 shadow-md rounded-lg">
            ...
            <div id="bemContainer" class="space-y-6">
                <?php
                $paslon_bem = [
                    ['id' => 1, 'name' => 'Paslon 1', 'img' => '../../assets/furina.jpg'],
                    ['id' => 2, 'name' => 'Paslon 2', 'img' => '../../assets/citlali.jpg'],
                    ['id' => 3, 'name' => 'Paslon 3', 'img' => '../../assets/lyney.jpg'],
                ];
        ...
        <section class="w-full max-w-4xl bg-white p-6 shadow-md rounded-lg">
            ...
            <div id="blmContainer" class="space-y-6">
                <?php
                $paslon_blm = [
                    ['id' => 'A', 'name' => 'Paslon A', 'img' => '../../assets/kazuha.jpg'],
                    ['id' => 'B', 'name' => 'Paslon B', 'img' => '../../assets/nahida.jpg'],
                ];
